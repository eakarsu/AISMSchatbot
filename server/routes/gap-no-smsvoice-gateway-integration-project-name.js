...
const FEATURE_SLUG = 'no-smsvoice-gateway-integration-project-name';
const FEATURE_TITLE = 'No SMS/voice gateway integration (project name implies SMS but no Twilio route)';
const PROJECT = 'AISMSchatbot';
